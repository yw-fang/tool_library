...
#    gruneisen_q = sum(gruneisen_for_band_list[0:len(gruneisen_for_band_list)])/band_length
    for j in range(band_length):
        gruneisen_q_sum = gruneisen_q_sum + band[j]['gruneisen']
    # print(j)
#    gruneisen_q = gruneisen_q_sum/6
    gruneisen_q = (band[1]['gruneisen']+band[2]['gruneisen']+band[3]['gruneisen']+band[4]['gruneisen']+band[5]['gruneisen']+band[0]['gruneisen'])/6
