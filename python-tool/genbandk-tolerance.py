...
__revision_date__ = "August 27th, 2019"
...
Different from genbandk.py, I add several parameters to control the tolerance
of finding symmetry. This may be useful for generating kpath of supercell structures with defects.
"""
...
high_k_path = psb.HighSymmKpath(prim.get_primitive_structure(2.0), symprec=2.05, angle_tolerance=5.0)
